    ...
    <section id={id} className="py-12 sm:py-18">
      <div className="max-w-[77rem] mx-auto px-8">
        <div className="flex items-center gap-4 mb-10">
          ...
          <span className="bg-almi-rose-bg dark:bg-dark-rose-bg text-almi-pink text-sm font-semibold px-3 py-1 rounded-full">
            {events.length}
          </span>
        </div>

        {events.length === 0 ? (
          <div className="text-center py-16 bg-gray-50 dark:bg-dark-surface rounded-sm">
